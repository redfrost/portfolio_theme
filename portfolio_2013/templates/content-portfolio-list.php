<div id="portfolio_custom">
	...
	<div id="portfolio_page_title">	
		<ul id="myTab" class="portfolio_menu">
			<li id="mainpage_li"><a href="http://simonalex.com/portfolio/"><</a></li>
			<li id="profile_li"><a href="#profile" data-toggle="tab">ALEX</a></li>
			<li id="works_li" class="active"><a href="#portfolio0" data-toggle="tab">WORKS</a></li>	
...
<div id="myTabContent" class="tab-content">
	<section id="mainpage" class="tab-pane fade">
   		<div class="row"> 
			...
			?>						  
			 ...
			 <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('large');?></a>								
			  <div class="front_titlebox">
			   <p class="front_title"><?php the_title(); ?> <span class="front_year"> /<?php the_time('Y'); ?></span></p>
			  </div>			
	...
	<section id="portfolio0" class="tab-pane fade active in"><hr class="hr_strong">
		<div class="row">    
